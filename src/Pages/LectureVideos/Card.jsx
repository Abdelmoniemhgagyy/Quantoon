...
function Card({SrcImg,name,data}) {
    ...
    const {setLeactureVideoes,leactureVideoes,setNameSheihk,setLogoSheihk} =useContext(GloableContext)
  ...
  return (
    <>
             {/* Card  */}
             <div className="border-white flex flex-col border-[2px]  shadow-sm rounded-xl w-[80%] md:w-[250px] md:h-[250px] bg-[#000] cursor-pointer"
                   onClick={handelData}>
                 <img className='w-full h-[80%] rounded-t-[8px] border-b-white border-b-[2px]'
                     src={SrcImg}
                     alt="sheikhsphoto" />             
